...
public class ByDateGetVisitor {
    ...
    public ByDateGetVisitor(String searchDate) {
    ...
    public void findByDate() {
        try {
            ...
            String sql2 = "SELECT * FROM masterdatetime right outer join visitorpass on masterdatetime.Pass_No=visitorpass.Pass_No"
